...
@router.post("/inspect", response_model=VisionOcrResponse, deprecated=True)
async def inspect_uploaded_image(
    file: UploadFile = File(...),
) -> VisionOcrResponse:
    """Deprecated compatibility route for older clients; now runs OCR-first."""

    return await extract_ocr_text(file)
